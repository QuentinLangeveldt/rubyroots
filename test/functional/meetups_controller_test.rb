...
class MeetupsControllerTest < ActionController::TestCase
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post :create, meetup: { date: @meetup.date, description: @meetup.description, direction: @meetup.direction, place: @meetup.place }
    end
  ...
  test "should update meetup" do
    put :update, id: @meetup, meetup: { date: @meetup.date, description: @meetup.description, direction: @meetup.direction, place: @meetup.place }
    assert_redirected_to meetup_path(assigns(:meetup))
  end
